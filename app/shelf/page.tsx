...
export default async function DashboardPage({ searchParams }: { searchParams: Promise<{ genre?: string; tab?: string }> }) {
    ...
    return (
        <div className="h-screen bg-white relative selection:bg-slate-200 flex flex-col overflow-hidden">
            ...
            <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-0 w-full flex flex-col h-full overflow-hidden">
                <div className="w-full shrink-0">
                    <div className="flex flex-col sm:flex-row items-center justify-between mb-4 pb-2 pt-2 gap-6">
